            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                <div class="p-6 space-y-6">
                    <div class="border-b pb-4">
                        <h3 class="text-2xl font-bold text-gray-900">New Student Profile</h3>
                        <p class="mt-2 text-gray-600">Fill in the student information below</p>
                    </div>
                    ...
                    <form method="POST" action="{{ route('student-profiles.store') }}">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <input type="text" name="year_level" id="year_level" value="{{ old('year_level') }}" required
                                    class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm">
                            </div>
                            ...
                            <div>
                                ...
                                <input type="text" name="department_cluster" id="department_cluster" value="{{ old('department_cluster') }}" required
                                    class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm"
                                    placeholder="e.g., SBAT, SEAS">
                            </div>
