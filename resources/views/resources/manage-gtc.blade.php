<x-app-layout>
    ...
    <div class="py-8">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="mb-6 flex justify-between items-center">
                <a href="{{ route('resources.gtc') }}" class="inline-flex items-center px-4 py-2 bg-gray-600 hover:bg-gray-700 text-white text-sm font-medium rounded-md shadow-sm transition-all duration-200">
                    <i class="fas fa-arrow-left mr-2"></i>Back to GTC
                </a>
                ...
                <form id="formModalForm" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <select name="subcategory" id="subcategory" class="w-full border-gray-300 rounded-md shadow-sm" required>
                            <option value="Testing & Application Forms">Testing & Application Forms</option>
                            <option value="Counseling Forms">Counseling Forms</option>
                            <option value="Evaluation & Assessment Forms">Evaluation & Assessment Forms</option>
                        </select>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="template_filename" id="templateFilename" class="w-full border-gray-300 rounded-md shadow-sm" placeholder="e.g., Application for SACLI Entrance Exam">
                    </div>
    ...
    <script>
        ...
        function openAddModal() {
            ...
            document.getElementById('subcategory').value = 'Testing & Application Forms';
