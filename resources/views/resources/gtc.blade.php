    ...
    <div class="py-8">
        <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="mb-6 flex justify-end">
                <a href="{{ route('resources.manage-gtc') }}" class="bg-blue-600 hover:bg-blue-700 text-white font-semibold px-6 py-2 rounded-md shadow-sm hover:shadow-md transition-all duration-200 flex items-center uppercase text-sm">
            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                ...
                <div class="p-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        @php
                            $icons = [
                                'Testing & Application Forms' => ['icon' => 'fa-clipboard-check', 'color' => 'blue'],
                                'Counseling Forms' => ['icon' => 'fa-user-friends', 'color' => 'green'],
                                'Evaluation & Assessment Forms' => ['icon' => 'fa-chart-line', 'color' => 'purple'],
                            ];
                        @endphp
