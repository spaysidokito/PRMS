    ...
    <div class="py-8">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="mb-6 flex justify-between items-center">
                <a href="{{ route('resources.pod') }}" class="inline-flex items-center px-4 py-2 bg-gray-600 hover:bg-gray-700 text-white text-sm font-medium rounded-md shadow-sm transition-all duration-200">
                    <i class="fas fa-arrow-left mr-2"></i>Back to POD
                </a>
            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                <div class="p-6">
                    <h3 class="text-lg font-semibold text-gray-900 mb-4">POD Forms</h3>
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                ...
                                <tr>
                                    <td colspan="4" class="px-6 py-4 text-center text-gray-500">
                                        No forms found. Click "Add New Form" to create one.
                                    </td>
                                </tr>
                                @endforelse
                            </tbody>
            ...
            <div class="mt-3">
                ...
                <form id="formModalForm" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="template_filename" id="templateFilename" class="w-full border-gray-300 rounded-md shadow-sm" placeholder="e.g., POD_FORM_TEMPLATE">
                    </div>
