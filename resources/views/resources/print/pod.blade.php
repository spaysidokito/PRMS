...
<head>
    ...
    <title>POD - Prefect of Discipline - Print View</title>
    <style>
        @media print {
            body { margin: 0; }
...
<body>
    <div class="no-print button-container">
        ...
        <a href="{{ route('resources.pod.download') }}" class="download-button">Download PDF</a>
        <a href="{{ route('resources.pod') }}" style="color: #007bff;">Back to Form</a>
    </div>

    <div class="header">
        <div class="title">Prefect of Discipline (POD)</div>
