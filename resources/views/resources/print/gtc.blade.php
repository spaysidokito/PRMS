...
<head>
    ...
    <title>GTC - Guidance Testing Center - Print View</title>
    <style>
        @media print {
            body { margin: 0; }
...
<body>
    <div class="no-print button-container">
        ...
        <a href="{{ route('resources.gtc.download') }}" class="download-button">Download PDF</a>
        <a href="{{ route('resources.gtc') }}" style="color: #007bff;">Back to Form</a>
    </div>

    <div class="header">
        <div class="title">Guidance Testing Center (GTC)</div>
