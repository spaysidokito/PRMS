        ...
        <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg card-hover">
            <div class="p-6">
                ...
                <div class="space-y-3">
                    ...
                    <a href="{{ route('form-submissions.my-submissions') }}" class="block p-4 bg-orange-50 rounded-lg hover:bg-orange-100 transition">
                        <div class="flex items-center">
                            <svg class="h-6 w-6 text-orange-600 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                            </svg>
                            <div>
                                <div class="font-medium text-gray-900">My Form Submissions</div>
                                <div class="text-sm text-gray-500">Submit and track your forms</div>
                            </div>
                        </div>
                    </a>
                </div>
